...
test('quotation filters render as a compact toolbar with a date-range group', () => {
  ...
  assert.match(source, /salespersonFilterOptions/)
  assert.match(source, /salespersonLabel/)
  ...
  assert.match(source, /xl:grid-cols-\[minmax\(0,1\.2fr\)_repeat\(4,minmax\(0,\.65fr\)\)_minmax\(0,1\.3fr\)\]/)
