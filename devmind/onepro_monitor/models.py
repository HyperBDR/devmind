    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="onepro_monitor_tenant_source_unique",
            )
        ]
        indexes = [
            models.Index(
                fields=["data_source", "status"],
                name="onepro_moni_data_so_bb4939_idx",
            ),
            models.Index(
                fields=["data_source", "name"],
                name="onepro_moni_data_so_24a173_idx",
            ),
        ]
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="onepro_monitor_license_source_tenant_scene_unique",
            )
        ]
        indexes = [
            models.Index(
                fields=["data_source", "scene"],
                name="onepro_moni_data_so_d12949_idx",
            ),
            models.Index(
                fields=["tenant", "scene"],
                name="onepro_moni_tenant__8a5776_idx",
            ),
        ]
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="onepro_monitor_host_source_unique",
            )
        ]
        indexes = [
            models.Index(
                fields=["data_source", "tenant"],
                name="onepro_moni_data_so_b431b2_idx",
            ),
            models.Index(
                fields=["data_source", "status"],
                name="onepro_moni_data_so_6c83d7_idx",
            ),
            models.Index(
                fields=["data_source", "health_status"],
                name="onepro_moni_data_so_333a64_idx",
            ),
        ]
