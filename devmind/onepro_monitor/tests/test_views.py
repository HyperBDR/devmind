...
from onepro_monitor.models import Host, Tenant


@pytest.mark.django_db
def test_list_data_sources(api_client, data_source):
    response = api_client.get("/api/v1/onepro-monitor/data-sources/")
...
def test_dashboard_endpoint_returns_summary(api_client):
    response = api_client.get("/api/v1/onepro-monitor/analyzer/dashboard/")
...
def test_export_hosts_requires_auth():
    ...
    response = client.get("/api/v1/onepro-monitor/hosts/export/")
...
def test_export_hosts_filtered_scope_applies_filters(api_client, data_source):
    ...
    response = api_client.get(
        "/api/v1/onepro-monitor/hosts/export/",
