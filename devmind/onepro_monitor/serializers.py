...
class DataSourceSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        if self.context.get("include_password"):
            payload["password"] = encryption_service.decrypt(instance.password)
        else:
            payload["password"] = ""
        return payload
    ...
    def create(self, validated_data):
        ...
        if password:
            validated_data["password"] = encryption_service.encrypt(password)
