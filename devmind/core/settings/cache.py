...
# Default: '/opt/devmind/cache' (container internal path)
# Note: Ensure directory exists and has proper permissions
CACHE_PATH = os.getenv('DEVMIND_CACHE_PATH', '/opt/devmind/cache')
...
CACHE_MIDDLEWARE_KEY_PREFIX = 'devmind'
